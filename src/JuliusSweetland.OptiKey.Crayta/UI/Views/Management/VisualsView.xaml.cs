    ...
    public partial class VisualsView : System.Windows.Controls.UserControl
    {
        ...
        private void CopyKeyboards(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            if (folderBrowser.ShowDialog() == DialogResult.OK)
            {
                ...
                {
                    // make a subdir 
                    outputFolder = Path.Combine(outputFolder, "OKGameOnKeyboards");
                ...
                {
                    MessageBox.Show(
                        OptiKey.Crayta.Properties.Resources.ERROR_COPYING_DETAILS + "\n\n" + ex.ToString(),
                        OptiKey.Crayta.Properties.Resources.ERROR_COPYING,
                        MessageBoxButton.OK,
